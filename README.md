...
Run the script:
    ...
    bash <(wget -qO- https://raw.githubusercontent.com/katxeus/install-rails/master/linux)

### Mac OS X

Run the script:

    bash <(curl -s https://raw.githubusercontent.com/katxeus/install-rails/master/mac)
